...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', '-m', nargs='?', default="~/PhD/llm-health-advice-evaluation/src/models/llama-2-13b-chat.Q8_0.gguf")
    ...
    parser.add_argument("--year", '-y', nargs='?', default=2022)
